...
class ApiQueryChatCompletion {
  /// Returns a new [ApiQueryChatCompletion] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is ApiQueryChatCompletion && other.message == message;
  ...
  @override
  String toString() => 'ApiQueryNLPConversational - [Text=$message, '
  ...
  /// Returns a new [ApiQueryChatCompletion] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApiQueryChatCompletion? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ApiQueryChatCompletion(
          message:
              mapValueOfType<List<Map<String, Object>>>(json, r'messages')!,
