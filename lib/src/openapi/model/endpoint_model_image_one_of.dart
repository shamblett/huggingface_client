...
class EndpointModelImageOneOf {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EndpointModelImageOneOf &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EndpointModelImageOneOf[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EndpointModelImageOneOf[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EndpointModelImageOneOf> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<EndpointModelImageOneOf>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EndpointModelImageOneOf>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EndpointModelImageOneOf.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
