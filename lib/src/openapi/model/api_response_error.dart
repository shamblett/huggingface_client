...
class ApiResponseError {
  ...
  bool operator ==(Object other) =>
      ...
      other is ApiResponseError && other.error == error;
  ...
  static List<ApiResponseError> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ApiResponseError>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ApiResponseError.listFromJson(
          entry.value,
          growable: growable,
        );
      }
